 ...
 */
public class OriginalReveiwAdapter extends BaseAdapter{

    private Context context;
    private List<ReadBookDetailsBean.ReveiwBean> lists = new ArrayList<>();

    public OriginalReveiwAdapter(Context context,List lists) {
        super();
