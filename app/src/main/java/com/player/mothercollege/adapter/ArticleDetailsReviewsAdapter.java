...
import com.player.mothercollege.bean.HotArticleDetailsBean;
 ...
 */
public class ArticleDetailsReviewsAdapter extends BaseAdapter{

    private Context context;
    private List<HotArticleDetailsBean.ReviewsBean> lists = new ArrayList<>();

    public ArticleDetailsReviewsAdapter(Context context, List lists) {
        super();
