 ...
 */
public class MyUpRefreshListview extends ListView implements AbsListView.OnScrollListener{
    ...
    public MyUpRefreshListview(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderView();
    ...
    private void initHeaderView() {
        ...
        // 设置最后刷新时间
        tvLastUpdateTime.setText("最近刷新: " + getLastUpdateTime());
...
//        }
     ...
     * @param listener
     */
    public void setOnRefreshListener(MyUpRefreshListview.OnRefreshListener listener) {
